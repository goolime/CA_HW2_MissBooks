...
const longtxt1 = `Alice was beginning to get very tired of sitting by her sister on the
...
const longtxt2 = `The rabbit-hole went straight on like a tunnel for some way and then
...
export function AboutUs() {
    return (
        <section className="about">
            <h1>About Us</h1>
            <LongTxt txt={longtxt1} />
            <LongTxt txt={longtxt2} length={200} closePostfix="Show More"  openPostfix="Show Less"/>
        </section>
    )
}